...
<script type="text/javascript">
	function gotoPage(pageNUm) {
		window.location.href = "oa/forum_forumShow.do?viewType=${viewType}&asc=${asc}&orderBy=${orderBy}&id=${forum.id}&currentPage="+ pageNUm;
	}
</script>
</head>
<body>
...
<s:form action="oa/forum_forumShow.do" id="pageForm">
	...
	<div id="MainArea">
		...
		<center>
			<div class="ItemBlock_Title1" style="width: 98%;">
				<font class="MenuPoint"> &gt; </font> <a href="oa/forum_list.do">论坛</a>
				<font class="MenuPoint"> &gt; </font>
				<s:property value="%{forum.name}" />
				<span style="margin-left:30px;"><a
					href='oa/topic_addUI.do?forumId=<s:property value="%{#forum.id}"/>'>
						<img align="absmiddle"
						src="style/blue/images/button/publishNewTopic.png" />
				</a> </span>
			</div>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr align="center" valign="middle">
						<td width="3" class="ForumPageTableTitleLeft"><img border="0"
							width="1" height="1" src="style/images/blank.gif" /></td>
						...
						<td width="3" class="ForumPageTableTitleRight"><img
							border="0" width="1" height="1" src="style/images/blank.gif" />
						</td>
					</tr>
						...
						<tbody class="dataContainer" datakey="topicList">
							<tr height="35" id="d0" class="template">
								...
								<td class="ForumTopicPageDataLine" align="center"><img
									src='style/images/topicType_${type}.gif' /></td>
								<td class="Topic"><a class="Default"
									href='oa/topic_topicShow.do?id=<s:property value="%{id}"/>'><s:property
											value="%{title}" /></a></td>
								<td class="ForumTopicPageDataLine">
									<ul class="ForumPageTopicUl">
										<li class="Author"><s:property value="%{author.name}" /></li>
										<li class="CreateTime"><s:date name="%{postDate}"
												format="yyyy-MM-dd HH:mm" /></li>
									</ul>
								</td>
								<td class="ForumTopicPageDataLine Reply" align="center"><b><s:property
											value="%{replyCount}" /></b></td>
								<td class="ForumTopicPageDataLine">
									<ul class="ForumPageTopicUl">
										<li class="Author"><s:property
												value="%{lastReply.author.name}" /></li>
										<li class="CreateTime"><s:date
												name="%{lastReply.postDate}" format="yyyy-MM-dd HH:mm" /></li>
									</ul>
								</td>
								<td></td>
							</tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" height="100%"
							...
							<tr valign=bottom>
								...
								<td><s:select name="viewType"
										...
										onchange="onSortByChange(this.value)" /> <s:select name="asc"
										list="#{true:'升序',false:'降序'}" /> <input type="IMAGE"
									src="style/blue/images/button/submit.PNG" align="ABSMIDDLE" />
								</td>
							</tr>
						</table>
					</div>
