...
<html>
  <head>
    ...
    <script type="text/javascript">
		...
		function disagree() {
			alert("aaa");
			document.forms[0].approval.value="false";
		}
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="oa/task_approve.do" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <s:if test="%{#outcomes.size() > 1}">
	                     <tr>
	                        <td>请选择下一个审批人</td>
	                        <td><s:radio name="outcome" list="%{#outcomes}"></s:radio>
	                    </tr>
                    </s:if>
                </table>
            </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="image" onclick="javascript:disagree();" src="style/blue/images/button/disagree.png"/>
            <!-- <img src="style/blue/images/button/sendBack.png" onClick="selectToNode();" /> -->
