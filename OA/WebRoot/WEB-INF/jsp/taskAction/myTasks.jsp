		...
		<s:iterator value="taskView">
	        <tbody id="TableData" class="dataContainer" datakey="formList">
				<tr class="TableDetail1 template">
					...
					<td><s:a href="oa/task_approveUI.do?taskId=%{task.id}&applicationId=%{application.id}">审批处理</s:a>
						<!-- <a href="showForm.html">查看申请信息</a> -->
						<s:a href="oa/application_approvedHistory.do?id=%{application.id}">查看流转记录</s:a>
					</td>
				</tr>
	        </tbody>
    	</s:iterator>
